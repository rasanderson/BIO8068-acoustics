...
file.copy(from=paste0("blackbird_songs/",list.files("blackbird_songs")), to="blackbirds")
file.copy(from=paste0("blackbird_alarm/",list.files("blackbird_alarm")), to="blackbirds")
...
query_xc(X = blackbird_alarm, path="blackbirds", file.name = c("Genus",
                                                              "Specific_epithet",
                                                              "Vocalization_type"))
```
